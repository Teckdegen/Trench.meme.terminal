// Browser-side trade entry point. Every Buy/Sell goes through the
// server fn `executeServerSwap` which signs via Para's server SDK.
// (the user delegates trade signing at first login) — ZERO popups.
